...
#----------------------------------------------------------------------
dim = 14
en_entree = "prono_input_14.csv"
en_sortie = "mes_500_grilles_14.csv"
...
def csv_writer(data, path):
    ...
    with open(path, "w", newline='') as csv_file:
        ...
        for (i,j,k,l,m,n,o,p,q,r,s,t,u,v) in itertools.product(range(3), repeat=dim):
            tupl = np.array([i,j,k,l,m,n,o,p,q,r,s,t,u,v], dtype=int)
            #on calcule l'esperance de cette combinaison
            esp = esperance(tupl)
            #on cree une liste qui contient toutes les grilles et l'esperance associee
            list_a_trier.append([esp,i,j,k,l,m,n,o,p,q,r,s,t,u,v])
